<#
    .DESCRIPTION
        This script starts a Power BI Embedded resource using PowerShell 5.1 and an Azure Automation Account,
...
try
{
	...
	Write-Output "Power BI Embedded Service Successfully Started"
}
catch
{
	Write-Error -Message $_.Exception
